...
def register_user_handlers(dp: Dispatcher):
    ...
    dp.register_message_handler(process_no_command, text=LEXICON_RU['no_button'])
    dp.register_message_handler(process_game_command, Text(equals=[LEXICON_RU['rock'], LEXICON_RU['paper'], LEXICON_RU['scissors']]))